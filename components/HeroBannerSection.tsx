        ...
        <div className="w-full mb-4 sm:mb-6 pl-4 sm:pl-8 md:pl-12 lg:pl-16 xl:pl-24">
          <div className="space-y-4 sm:space-y-6">
            <div className="space-y-3 sm:space-y-4">
              <div className="text-xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold leading-none text-left pb-4 sm:pb-6">
                TechByJZ
              </div>
              ...
              <p className="text-sm sm:text-base md:text-lg lg:text-xl text-[var(--foreground-low)] leading-relaxed text-left max-w-2xl">
                ...
                Explore the intersection of innovation and imagination.
              </p>
            </div>
